...
public:
	...
	void PurchaseItem(URPGItem* InItem, const int32 Quantity);
	...
	URPGTokenItem* GetSoulsItem() { return SoulsItem; }
	bool CanPurchaseItem(const URPGItem* InItem);
